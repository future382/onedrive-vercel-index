...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'adkinsm@adkinsm.onmicrosoft.com',
  ...
  email: 'mailto:adkimsm@adkimsm.club',
